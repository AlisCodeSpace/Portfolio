export const Mail01Icon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} className="text-gold" color={"#000000"} fill={"none"} {...props}>
...
export const Calendar03Icon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} className="text-gold" color={"#000000"} fill={"none"} {...props}>
...
export const Location01Icon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} className="text-gold" color={"#000000"} fill={"none"} {...props}>
...
export const Linkedin01Icon = (props) => (
...
export const Github01Icon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={22} height={22} color={"#000000"} fill={"none"} {...props}>
...
export const BookOpen01Icon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={18} height={18} className="text-gold" color={"#000000"} fill={"none"} {...props}>
